...
reports = {
    "epi_public" : Report(name="epi_public", source="epi",source_fn=epi_report.epi_report, dest="", site="public", cleaning=epi_report.pages_clean(self.data)),
    "epi_adviser" : Report(name="epi_adviser", source="epi",source_fn=epi_report.epi_report, dest="", site="advisernet", cleaning=epi_report.pages_clean(self.data)),
