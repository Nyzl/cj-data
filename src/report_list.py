...
reports = {
    "epi_public" : Report(name="epi_public", source="epi",source_fn=epi_report.epi_pages_report, dest="", site="public"),
    "epi_adviser" : Report(name="epi_adviser", source="epi",source_fn=epi_report.epi_pages_report, dest="", site="advisernet"),
