...
reports = {
    ...
    'ga_public_rating' : Report(
        ...
        source_kwargs={'site':'public', 'type':'rating', 'period':'90daysAgo'}, 
        clean_kwargs={},
        send_kwargs={}, 
        site='public', 
        source_args='rating'),
    'ga_public_size' : Report(
        ...
        source='ga', 
        source_fn=ga_data.get_ga_report, 
        source_kwargs={'site':'public', 'type':'size', 'period':'90daysAgo'},
        clean_kwargs={},
        send_kwargs={}, 
        site='public', 
        source_args='size'),
    'ga_adviser_rating' : Report(
        ...
        source='ga',
        source_fn=ga_data.get_ga_report,
        source_kwargs={'site':'advisernet', 'type':'rating', 'period':'90daysAgo'},
        clean_kwargs={},
        send_kwargs={}, 
        site='advisernet', 
        source_args='rating'),
    'ga_adviser_size' : Report(
        ...
        source='ga', 
        source_fn=ga_data.get_ga_report,
        source_kwargs={'site':'advisernet', 'type':'size', 'period':'90daysAgo'},
        clean_kwargs={},
        send_kwargs={}, 
        site='advisernet', 
        source_args='size'),
